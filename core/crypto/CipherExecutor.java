 ...
 *
 */
public class CipherExecutor implements Serializable {
	 ...
	 */
	public CipherExecutor(CryptoAlgorithm algorithm) {
	 ...
	 * @param algorithm 算法枚举
	 */
	public CipherExecutor(String algorithm) {
		this(algorithm, null);
	}
	 ...
	 * @since 4.5.1
	 */
	public CipherExecutor(DigestAlgorithm algorithm, Provider provider) {
	 ...
	 * @since 4.5.1
	 */
	public CipherExecutor(String algorithm, Provider provider) {
	 ...
	 */
	public CipherExecutor init(String algorithm, Provider provider) {
		if(null == provider) {
	 ...
	 * @since 4.4.3
	 */
	public CipherExecutor setSalt(byte[] salt) {
		this.salt = salt;
		return this;
	}
	 ...
	 * @since 4.4.3
	 */
	public CipherExecutor setSaltPosition(int saltPosition) {
	 ...
	 * @return this
	 */
	public CipherExecutor setDigestCount(int digestCount) {
